...
link_prefix = "https://github.com/nosamaj/SewerOverflowsEA/blob/master"

data_links = {  "2021": "/overflows2021.csv" }


def get_data_columns(df, category, year=2021):
    if year == 2021:
...
# This section defines the map to be created 
...
# This is the bit which actually draws the map and creates the 
